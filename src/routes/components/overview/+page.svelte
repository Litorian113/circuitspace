		...
		<div class="sidebar-footer">
			<div class="user-progress">
				...
				<div class="xp-info">
					...
					<span class="components-completed">
						{allComponents.filter(c => getProgressPercentage(c.id) === 100).length}/{allComponents.length} mastered
					</span>
				</div>
				<div class="level-breakdown">
					<div class="mini-stat">
						<span class="mini-stat-icon">L5</span>
						<span class="mini-stat-text">{allComponents.filter(c => getComponentProgress(c.id).level === 5).length} Level 5</span>
					</div>
					<div class="mini-stat">
						<span class="mini-stat-icon">L4</span>
						<span class="mini-stat-text">{allComponents.filter(c => getComponentProgress(c.id).level >= 4).length} Level 4+</span>
					</div>
					<div class="mini-stat">
						<span class="mini-stat-icon">L3</span>
						<span class="mini-stat-text">{allComponents.filter(c => getComponentProgress(c.id).level >= 3).length} Level 3+</span>
					</div>
				</div>
				<div class="achievement-preview">
					...
					<div class="achievement-text">
						...
						<span class="achievement-desc">Keep building skills!</span>
					</div>
				</div>
			</div>
		</div>
